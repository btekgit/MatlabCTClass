function C= fillhole3d(A,B, resolution)
%function C= fillhole3d(A,B, resolution)
% function implements 3d binary hole filling  function for cell array
...
if (cell_a)
    t= A{1}(1,1);
    if(isscalar(B))
        C = morph_mex_int16(A,resolution(1),resolution(2),resolution(3), B,6);
    else
