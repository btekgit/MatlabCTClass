function C= dilate3d(A,B)
% C=dilate3d(A,B) for CT  
% Only int16 input is allowed.
% B is window size. Note that CT resolution is passed to the function
%--------------------------------------------------------------------------
% This function implements 3d dilation of a CT set.
%       F. Boray Tek, 18/06/08
%       Last Updated, 
%--------------------------------------------------------------------------
%   Inputs
%--------------------------------------------------------------------------
%   A    :   this is the CT set, int16
%   B    :   this is scalar 
%                 
%--------------------------------------------------------------------------
%  Outputs
