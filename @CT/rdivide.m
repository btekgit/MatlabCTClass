...
% C=rdivide(A,B) for CT overloaded. A./B
%--------------------------------------------------------------------------
% This function implements pixel by pixel division of a CT set, or CT set and 
% numeric, or a CT set and cell array 
%       F. Boray Tek, 20/05/08
%       Last Updated, 20/05/08 -> divide sign replaced with "imdivide" to use
%       intel performance library where possible.
%
%--------------------------------------------------------------------------
%   Inputs
%--------------------------------------------------------------------------
